...
public class TSEPositionBluePipeline extends OpenCvPipeline
{
    ...
    static final Point CENTER_REGION__TOPLEFT_ANCHOR_POINT = new Point(310,740);
    static final Point RIGHT_REGION_TOPLEFT_ANCHOR_POINT = new Point(920,740);
