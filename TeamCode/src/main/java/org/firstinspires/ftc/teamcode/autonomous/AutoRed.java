...
@Autonomous(group = "drive", preselectTeleOp = "RedTeleOp")
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while(opModeIsActive() && ayesha.isBusy()) {
            if(ayesha.retrieveCollectorDistance() < 3.3) {
                ...
                exitWarehouseCycle1 = ayesha.trajectorySequenceBuilder(new Pose2d(ayesha.getPoseEstimate().getX(), -1.5, Math.toRadians(0)))
                 ...
                 //while(exitWarehouseCycle1 == null) {}
        ...
        while(opModeIsActive() && ayesha.isBusy()) {
            if(ayesha.retrieveCollectorDistance() < 3.3) {
                ...
                exitWarehouseCycle2 = ayesha.trajectorySequenceBuilder(new Pose2d(ayesha.getPoseEstimate().getX(), -1.5, Math.toRadians(0)))
                        .setReversed(true)
                        .splineToSplineHeading(new Pose2d(-8.1, 16.8, Math.toRadians(-70)), Math.toRadians(110))
                        .build();

                //while(exitWarehouseCycle2 == null) {}
        ...
        while(opModeIsActive() && ayesha.isBusy()) {
            if(ayesha.retrieveCollectorDistance() < 3.3) {
                ...
                exitWarehouseCycle3 = ayesha.trajectorySequenceBuilder(new Pose2d(ayesha.getPoseEstimate().getX(), -2.2, Math.toRadians(0)))
                        .setReversed(true)
                        .splineToSplineHeading(new Pose2d(-6, 17.7, Math.toRadians(-70)), Math.toRadians(110))
                        .build();

                //while(exitWarehouseCycle3 == null) {}
        ...
        if(!cycle3Collected) {
            ...
            exitWarehouseCycle3 = ayesha.trajectorySequenceBuilder(new Pose2d(ayesha.getPoseEstimate().getX(), -2.2, Math.toRadians(11)))
                    .setReversed(true)
                    .splineToSplineHeading(new Pose2d(-6.5, 17.7, Math.toRadians(-70)), Math.toRadians(110))
                    .build();
        ...
        Trajectory enterWarehouseCycle4 = ayesha.trajectoryBuilder(exitWarehouseCycle3.end())
                ...
                .splineTo(new Vector2d(56, -3), Math.toRadians(7),
                        AyeshaCancelable.getVelocityConstraint(30, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        AyeshaCancelable.getAccelerationConstraint(50))
                .addDisplacementMarker(0.18, 0, () -> {
                    ayesha.lowerDropper();
                    readyForCollectionNoStart.start();
                })
        ...
        while(opModeIsActive() && ayesha.isBusy()) {
            if(ayesha.retrieveCollectorDistance() < 3.3) {
                ...
                exitWarehouseCycle4 = ayesha.trajectorySequenceBuilder(new Pose2d(ayesha.getPoseEstimate().getX(), -3, Math.toRadians(7)))
                        .setReversed(true)
                        //.splineTo(new Vector2d(25, -3), Math.toRadians(180))
                        .splineToSplineHeading(new Pose2d(-4.9, 18.8, Math.toRadians(-70)), Math.toRadians(110))
                        .build();

                //while(exitWarehouseCycle4 == null) {}
        ...
        if(!cycle4Collected) {
            ...
            exitWarehouseCycle4 = ayesha.trajectorySequenceBuilder(new Pose2d(ayesha.getPoseEstimate().getX(), -3, Math.toRadians(18)))
                    .setReversed(true)
                    .splineTo(new Vector2d(25, -3), Math.toRadians(180))
                    .splineToSplineHeading(new Pose2d(-4.9, 18.8, Math.toRadians(-68)), Math.toRadians(112))
                    .build();
        ...
        Trajectory enterWarehouseCycle5 = ayesha.trajectoryBuilder(exitWarehouseCycle4.end())
                .splineToSplineHeading(new Pose2d(36.5, -3, Math.toRadians(4)), Math.toRadians(0))
                .splineTo(new Vector2d(58, -3), Math.toRadians(7),
                        AyeshaCancelable.getVelocityConstraint(30, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
                        AyeshaCancelable.getAccelerationConstraint(50))
                .addDisplacementMarker(0.18, 0, () -> {
                    ayesha.lowerDropper();
        ...
        while(opModeIsActive() && ayesha.isBusy()) {
            if(ayesha.retrieveCollectorDistance() < 3.3) {
                ...
                exitWarehouseCycle5 = ayesha.trajectorySequenceBuilder(new Pose2d(ayesha.getPoseEstimate().getX(), -3, Math.toRadians(7)))
                        .setReversed(true)
                        //.splineTo(new Vector2d(25, -3), Math.toRadians(180))
                        .splineToSplineHeading(new Pose2d(-5, 19.4, Math.toRadians(-69)), Math.toRadians(111))
                        .build();

                //while(exitWarehouseCycle5 == null) {}
        ...
        if(!cycle5Collected) {
            ...
            exitWarehouseCycle5 = ayesha.trajectorySequenceBuilder(new Pose2d(ayesha.getPoseEstimate().getX(), -3, Math.toRadians(18)))
                    .setReversed(true)
                    .splineTo(new Vector2d(25, -3), Math.toRadians(180))
                    .splineToSplineHeading(new Pose2d(-5, 19.4, Math.toRadians(-69)), Math.toRadians(111))
                    .build();
        ...
        Trajectory enterWarehouseCycle6 = ayesha.trajectoryBuilder(exitWarehouseCycle5.end())
                .splineToSplineHeading(new Pose2d(32, -3, Math.toRadians(-4)), Math.toRadians(0)) //36 for x
        ...
        while(opModeIsActive() && !isStopRequested()) {
            if(ayesha.retrieveCollectorDistance() < 3.3) {
                ...
                exitWarehouseCycle6 = ayesha.trajectorySequenceBuilder(new Pose2d(ayesha.getPoseEstimate().getX(), ayesha.getPoseEstimate().getY(), ayesha.getPoseEstimate().getHeading()))
                        .setReversed(true)
                        .splineTo(new Vector2d(25, -3), Math.toRadians(180))
                        .splineToSplineHeading(new Pose2d(-3.7, 19.7, Math.toRadians(-69)), Math.toRadians(111))
                        .build();
        ...
        Trajectory parkInWarehouse = ayesha.trajectoryBuilder(exitWarehouseCycle6.end())
...
//        if(jiggleCount == 0) {
//            Trajectory enterWarehouseCycle7 = ayesha.trajectoryBuilder(exitWarehouseCycle6.end())
//                    .splineToSplineHeading(new Pose2d(32, -3, Math.toRadians(-4)), Math.toRadians(0))
//                    .splineTo(new Vector2d(48, 6), Math.toRadians(13))
//                    .addDisplacementMarker(0.18, 0, () -> {
//                        ayesha.lowerDropper();
//                        readyForCollectionNoStart.start();
//                    })
...
//                    .build();
//
//            ayesha.followTrajectoryAsync(enterWarehouseCycle7);
//
//            while(opModeIsActive() && !isStopRequested()) {
//                if(ayesha.retrieveCollectorDistance() < 3.3) {
//                    ayesha.breakFollowing();
//                    ayesha.setDrivePower(new Pose2d());
//
//                    exitWarehouseCycle7 = ayesha.trajectorySequenceBuilder(new Pose2d(ayesha.getPoseEstimate().getX(), ayesha.getPoseEstimate().getY(), ayesha.getPoseEstimate().getHeading()))
//                            .setReversed(true)
//                            .splineTo(new Vector2d(25, -3), Math.toRadians(180))
//                            .splineToSplineHeading(new Pose2d(-3.3, 19.6, Math.toRadians(-68)), Math.toRadians(112))
//                            .addDisplacementMarker(0.3, 0, () -> {
//                                rotateCapX.start();
//                            })
//                            .addDisplacementMarker(0.4, 0, () -> {
//                                spinMeasuringTape.start();
//                            })
//                            .build();
//
//                    completeCollection.start();
//                    ayesha.followTrajectorySequence(exitWarehouseCycle7);
//                    scoreFreightPreloaded.start();
//
//                    break;
//                }
...
//
//        if(jiggleCount == 0) {
//            parkInWarehouse = ayesha.trajectoryBuilder(exitWarehouseCycle7.end())
//                    .lineToLinearHeading(new Pose2d(7.5, 15, Math.toRadians(-90)),
//                            AyeshaCancelable.getVelocityConstraint(80, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),
//                            AyeshaCancelable.getAccelerationConstraint(80))
//                    .build();
//        }
